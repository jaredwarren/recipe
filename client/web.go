...
func (c *Client) CreateWeb(ctx context.Context, path string, payload *CreateWebPayload, contentType string) (*http.Response, error) {
	req, err := c.NewCreateWebRequest(ctx, path, payload, contentType)
	if err != nil {
		return nil, err
	}
...
func (c *Client) NewCreateWebRequest(ctx context.Context, path string, payload *CreateWebPayload, contentType string) (*http.Request, error) {
...
func (c *Client) UpdateWeb(ctx context.Context, path string, payload *UpdateWebPayload, contentType string) (*http.Response, error) {
	req, err := c.NewUpdateWebRequest(ctx, path, payload, contentType)
	if err != nil {
		return nil, err
	}
	return c.Client.Do(ctx, req)
...
func (c *Client) NewUpdateWebRequest(ctx context.Context, path string, payload *UpdateWebPayload, contentType string) (*http.Request, error) {
	var body bytes.Buffer
	if contentType == "" {
		contentType = "*/*" // Use default encoder
	}
