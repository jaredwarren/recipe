...
func (mt *RecipeRecipe) Validate() (err error) {
	...
	if mt.Difficulty != nil {
		if *mt.Difficulty < 0.000000 {
			err = goa.MergeErrors(err, goa.InvalidRangeError(`response.difficulty`, *mt.Difficulty, 0.000000, true))
		}
	}
	if mt.Difficulty != nil {
		if *mt.Difficulty > 1.000000 {
			err = goa.MergeErrors(err, goa.InvalidRangeError(`response.difficulty`, *mt.Difficulty, 1.000000, false))
		}
	}
	...
	if mt.Rating != nil {
		if *mt.Rating < 0.000000 {
			err = goa.MergeErrors(err, goa.InvalidRangeError(`response.rating`, *mt.Rating, 0.000000, true))
		}
	}
	if mt.Rating != nil {
		if *mt.Rating > 1.000000 {
			err = goa.MergeErrors(err, goa.InvalidRangeError(`response.rating`, *mt.Rating, 1.000000, false))
		}
	}
	if mt.Source != nil {
