...
func CreateRecipeCreated(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.RecipeController, payload *app.RecipePayload) http.ResponseWriter {
	...
	u := &url.URL{
		Path: fmt.Sprintf("/recipe/recipe"),
	}
	...
	createCtx, err := app.NewCreateRecipeContext(goaCtx, service)
	if err != nil {
...
func CreateRecipeOK(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.RecipeController, payload *app.RecipePayload) (http.ResponseWriter, *app.RecipeRecipe) {
	...
	if resp != nil {
		...
		if !ok {
			t.Fatalf("invalid response media: got %+v, expected instance of app.RecipeRecipe", resp)
		}
		err = mt.Validate()
		if err != nil {
...
func CreateRecipeOKIngredient(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.RecipeController, payload *app.RecipePayload) (http.ResponseWriter, *app.RecipeRecipeIngredient) {
	...
	if resp != nil {
		var ok bool
		mt, ok = resp.(*app.RecipeRecipeIngredient)
		if !ok {
			t.Fatalf("invalid response media: got %+v, expected instance of app.RecipeRecipeIngredient", resp)
		}
		err = mt.Validate()
		if err != nil {
			t.Errorf("invalid response media type: %s", err)
...
func DeleteRecipeInternalServerError(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.RecipeController, id string) (http.ResponseWriter, error) {
	...
	rw := httptest.NewRecorder()
	u := &url.URL{
		Path: fmt.Sprintf("/recipe/recipe/%v", id),
	}
	...
	goaCtx := goa.NewContext(goa.WithAction(ctx, "RecipeTest"), rw, req, prms)
	deleteCtx, err := app.NewDeleteRecipeContext(goaCtx, service)
	if err != nil {
		panic("invalid test data " + err.Error()) // bug
	}
...
// DeleteRecipeOK runs the method Delete of the given controller with the given parameters.
// It returns the response writer so it's possible to inspect the response headers and the media type struct written to the response.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func DeleteRecipeOK(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.RecipeController, id string) (http.ResponseWriter, *app.RecipeRecipe) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
...
// DeleteRecipeOKIngredient runs the method Delete of the given controller with the given parameters.
// It returns the response writer so it's possible to inspect the response headers and the media type struct written to the response.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func DeleteRecipeOKIngredient(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.RecipeController, id string) (http.ResponseWriter, *app.RecipeRecipeIngredient) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
...
func ShowRecipeNotFound(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.RecipeController, id string) http.ResponseWriter {
	...
	goaCtx := goa.NewContext(goa.WithAction(ctx, "RecipeTest"), rw, req, prms)
	showCtx, err := app.NewShowRecipeContext(goaCtx, service)
	if err != nil {
		panic("invalid test data " + err.Error()) // bug
	}
...
func UpdateRecipeBadRequest(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.RecipeController, id string, payload *app.RecipePayload) (http.ResponseWriter, error) {
	...
	goaCtx := goa.NewContext(goa.WithAction(ctx, "RecipeTest"), rw, req, prms)
	updateCtx, err := app.NewUpdateRecipeContext(goaCtx, service)
	if err != nil {
		panic("invalid test data " + err.Error()) // bug
	}
